namespace RedSilver2.Framework.Inputs
{
    ...
    {
        public OverrideableHoldInput(string name, KeyboardKey defaultKeyboardKey, GamepadButton defaultGamepadKey) : base(name, defaultKeyboardKey, defaultGamepadKey)
        {
        }
